...
namespace Footsies
{
    ...
    public class Fighter
    {
        ...
        private bool IsEvadeInput(int input)
        {
            return (input & (int)InputDefine.Evade) > 0;
        }
        ...
        private bool IsUpInput(int input)
        {
            return (input & (int)InputDefine.Up) > 0;
        }

        private bool IsDownInput(int input)
        {
